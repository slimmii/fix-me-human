...
export default forwardRef<RetroEditorHandle,Props>(function RetroEditor(props,ref){
 ...
 lineNumbers(),highlightActiveLineGutter(),history(),highlightActiveLine(),bracketMatching(),closeBrackets(),highlightSelectionMatches(),indentUnit.of('  '),javascript({jsx:true,typescript:true}),syntaxHighlighting(colors),
 ...
 '.cm-scroller':{fontFamily:'"Courier New", monospace',lineHeight:'1.45',overflow:'auto'},'.cm-content':{padding:'8px 0',caretColor:'#ffff55',caretShape:'block'},'.cm-line':{padding:'0 12px'},
 '.cm-dropCursor':{borderLeft:'2px solid #ffff55'},'.cm-gutters':{backgroundColor:'#000080',color:'#5555aa',borderRight:'1px solid #5555aa'},'.cm-gutterElement':{padding:'0 9px 0 8px'},'.cm-activeLineGutter':{backgroundColor:'#000080',color:'#ffff55'},'.cm-activeLine':{backgroundColor:'#ffffff08'},
