**FROM:** B.U.G., Your Extremely Qualified Supervisor  
**SUBJECT:** A greeting for management

Build a small React application that displays **Hello B.U.G.** as a heading.

- Export a function component with a capitalized name, such as `App`.
- Return an `h1` heading containing exactly **Hello B.U.G.**
